...
const createDocLinks = (lang: string): DocMap => {
  ...
  return {
    ...
    datadogIntegration: `https://docs.emqx.com/${lang}/emqx/${EMQX_VERSION}/observability/datadog.html`,
    ...
    influxDbBatchSettings: `https://docs.emqx.com/${lang}/emqx/${EMQX_VERSION}/data-integration/data-bridge-influxdb.html#${createBatchSettingHash(
      lang,
    )}`,
    iotDbBatchSettings: `https://docs.emqx.com/${lang}/emqx/${EMQX_VERSION}/data-integration/data-bridge-iotdb.html#${createBatchSettingHash(
      lang,
    )}`,
