...
export type EmqxOcppSchemaUpstreamTopicOverrideMapping = {
  $name?: string
}

export interface EmqxOcppSchemaUpstream {
  topic: string
  topic_override_mapping?: EmqxOcppSchemaUpstreamTopicOverrideMapping
  reply_topic: string
  error_topic: string
}

export interface EmqxOcppSchemaDnstream {
  topic: string
