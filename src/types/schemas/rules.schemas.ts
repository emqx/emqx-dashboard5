...
export type RuleEngineRuleEventsTestColumns = { [key: string]: unknown }
...
export type RuleEngineCtxAlarmDeactivatedDetails = { [key: string]: unknown }
...
export type RuleEngineCtxAlarmActivatedDetails = { [key: string]: unknown }
