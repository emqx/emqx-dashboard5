  ...
  <div class="app-wrapper">
    ...
    <el-card shadow="never" class="app-card slow-sub-config" v-loading="isLoading">
      <div class="config-block">
        ...
        <el-form ref="formCom" :model="configForm" :rules="rulesOfConfigForm" label-position="top" size="small">
          <el-row :gutter="32">
            <el-col :span="12">
            ...
            <el-col :span="12">
              <el-form-item :label="$t('SlowSub.noticeBatchSize')" required prop="notice_batch_size">
                <template #label>
...
const rulesOfConfigForm = {
  ...
  top_k_num: [...createRequiredRule(t(`SlowSub.${fieldNameMap.top_k_num}`)), ...createIntFieldRule(0, 1000)],
  expire_interval: [
  ...
  notice_batch_size: [...createRequiredRule(t(`SlowSub.${fieldNameMap.notice_batch_size}`)), ...createIntFieldRule()],
};
