<template>
  <div class="app-wrapper delayed-pub" v-loading="tbLoading">
    <div class="section-header">
      <div></div>
      <el-button :icon="Setting" @click="showConfigDrawer = true">
        {{ $t('Base.setting') }}
      </el-button>
    </div>
  ...
  <DelayedConfigDrawer v-model="showConfigDrawer" />
</template>
...
import DelayedConfigDrawer from './components/DelayedConfigDrawer.vue'
