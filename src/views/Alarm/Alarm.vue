  ...
  methods: {
    ...
    async loadData(params = {}) {
      ...
      if (res) {
        ...
        this.$store.dispatch(
          "SET_ALERT_COUNT",
          this.currentAlarmData.length || 0
        );
    ...
    getStateText(state) {
      ...
      return (
        stateMap[state] ||
        `${this.$t("Alarm.abnormal")} ${state} ${this.$t("Alarm.second")}`
      );
    },
  },
};
